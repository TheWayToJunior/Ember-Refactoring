...
namespace Ember.Server.Controllers
{
    ...
    public class UserRolesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<UserRoles>>> GetAll([FromQuery] PaginationRequest pagination,
            string role = "")
        {
            if (pagination == null)
            {
        ...
        public async Task<ActionResult<RoleStatisticsResponse>> GerRoleStatistics()
        {
